...
For compatible text Responses or Chat Completions, use the official OpenAI SDK
...
reusing an integration that sends tools, non-text content, sampling controls,
or `store: false`.
