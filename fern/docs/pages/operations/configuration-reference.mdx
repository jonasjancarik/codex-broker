...
| `auth/owners/<auth-principal-hash>/profiles/<profile>/codex-home` | Per-principal/profile Codex home. The legacy `owners` directory name is preserved for migration compatibility. |
